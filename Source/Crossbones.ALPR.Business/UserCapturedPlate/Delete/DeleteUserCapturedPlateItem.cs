...
{
    public class DeleteUserCapturedPlateItem : SysSerialItemMessage
    {
        public DeleteUserCapturedPlateItem(SysSerial id, DeleteCommandFilter deletdCommandFilter, long userId = 0, long capturedPlateId = 0) : base(id)
        {
            UserId = userId;
